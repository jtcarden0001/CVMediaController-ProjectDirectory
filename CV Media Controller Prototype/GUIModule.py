...
class VideoFrame(tk.Frame):
    ...
    def __init__(self, root):
        ...
        self.player_time_label.grid(row=1, column=3, columnspan=1, padx=8, sticky='W')
        ...
        self.state_label.grid(row=4, column=0, columnspan=30, padx=8, sticky='W')
        self.last_input_message_label = tk.Label(self, textvariable=self.last_input_message)
        self.last_input_message_label.grid(row=4, column=2, columnspan=40, padx=8, sticky='W')
